...
const DropDown = ({ currentMode }) => (
    <div className='w-28 border-1 border-color px-2 py-1 rounded-md'>
        <DropDownListComponent
            ...
            style={{ border: 'none', color: currentMode === 'Dark' && 'Light' }}
            value='1'
        ...
        <div className='mt-24'>
            <div className='flex flex-wrap lg:flex-nowrap justify-center'>
                <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center'>
                    ...
                    <div className='mt-6'>
                        <Button color='white' text='Download' borderRadius='10px' bgColor={currentColor} />
                    </div>
                </div>
                <div className='flex m-3 flex-wrap justify-center gap-1 items-center'>
                    {earningData.map((item) => (
                        ...
                        >
                            ...
                            <p className='className="text-sm text-gray-400  mt-1"'>{item.title}</p>
                        </div>
                    ))}
                </div>
            </div>
            ...
            <div className='flex gap-10 m-4 flex-wrap justify-center'>
                <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg p-6 rounded-2xl'>
                    ...
                    <div className='flex justify-between items-center mt-5 border-t-1 border-color'>
                        <div className='mt-3'>
                            <Button color='white' text='Add' borderRadius='10px' bgColor={currentColor} />
                        </div>
                ...
                <div className='w-400 bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl p-6 m-3'>
                    ...
                    <div className='mt-10'>
                        ...
                        <div className='mt-8'>
                            ...
                            <div className='mt-3'>
                                <Button color='white' text='Read More' borderRadius='10px' bgColor={currentColor} />
                            </div>
                        </div>
                    </div>
                </div>
